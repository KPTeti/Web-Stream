<?php
    ...
    $sql = "INSERT INTO migration (Nama_Teknisi, Kode_Angka_QR, Nama_ODP, Port_ODP, No_Service, SN_ONT) VALUES ('$Nama_Teknisi', '$Kode_Angka_QR', '$Nama_ODP', '$Port_ODP', '$No_Service', '$SN_ONT')";
...
header("refresh:5; url=migration.html");
