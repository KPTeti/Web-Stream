<?php
    ...
    $sql = "INSERT INTO migration (Nama_Teknisi, Kode_QR_Port, Nama_ODP, Port_ODP, No_Service, SN_ONT) VALUES ('$Nama_Teknisi', '$Kode_QR_Port', '$Nama_ODP', '$Port_ODP', '$No_Service', '$SN_ONT')";
...
header("refresh:5; url=migration.php");
