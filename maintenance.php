...
<head>
  ...
  <body>
    ...
    <section id="headtext">
      <div class="container">
        <h2> Layanan Pengisian Maintenance </h2>
      </div></section>

      <form class="form-basic" name="form" id="form" method="POST" action="insert_maintenance.php">
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $('#umpanbalik').load('cekMaintenance.php').show();

        $('#Kode_QR_Port').keyup(function() {
          //$('#umpanbalik').append('d');
          $.post("cekMaintenance.php",
