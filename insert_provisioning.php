<?php
    ...
    $sql = "INSERT INTO provisioning (Nama_Teknisi, Kode_QR_Port, Nama_ODP, Port_ODP, No_Service, SN_ONT) VALUES ('$Nama_Teknisi', '$Kode_QR_Port', '$Nama_ODP', '$Port_ODP', '$No_Service', '$SN_ONT')";
